...
extension Strings {
    static let ru = Strings(
        ...
        secureInputTitle: "Защищённый ввод включён",
        secureInputHeldFormat: "Его удерживает %@, поэтому Vorssaint не может печатать за вас. Снимите фокус с поля пароля или завершите работу приложения, чтобы освободить его.",
        secureInputUnattributed: "Ни одно запущенное приложение его не удерживает. Выйдите из системы и войдите снова, чтобы сбросить его.",
        secureInputUnidentified: "Не удалось определить приложение, которое его удерживает, поэтому Vorssaint не может печатать за вас.",
        secureInputRevealFormat: "Показать %@",
