...
extension Strings {
    static let zhHK = Strings(
        ...
        showMenuBarIconCaption: "如果 Vorssaint 的圖示消失了（選單列空間不足時，macOS 可能會隱藏圖示；有瀏海的 Mac 較常見），請從「應用程式」或 Spotlight 重新開啟 Vorssaint。這會重新建立圖示；如果圖示仍被隱藏，則會開啟此視窗。你已經來到這裡時，上方按鈕也有相同作用。減少選單列圖示或 Vorssaint 指標，可大幅降低再次發生的機會。",
