...
extension Strings {
    static let zhHans = Strings(
        ...
        uninstallerCommandBarBrowseTitle: "卸载应用程序",
        uninstallerCommandBarToggle: "在命令栏中显示",
        uninstallerCommandBarCaption: "在命令栏中选择并卸载应用。",
        uninstallerCommandBarFinderTitle: "卸载 Finder 中选中的应用",
        uninstallerSelectionUnavailable: "请在 Finder 中选择可移除的应用，或从列表中选择其他应用。",
        ...
        secureInputTitle: "安全输入已开启",
        secureInputHeldFormat: "%@ 正在占用它，因此 Vorssaint 无法代你输入。退出其密码栏或退出该 App 即可释放。",
        secureInputUnattributed: "没有正在运行的 App 占用它。请注销后重新登录以清除。",
        secureInputUnidentified: "无法识别占用它的 App，因此 Vorssaint 无法代你输入。",
        secureInputRevealFormat: "显示 %@",
